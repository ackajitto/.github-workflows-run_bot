...
def ask_gemini_to_summarize(raw_web_data):
    ...
    # 🧠 บรีฟคุมเข้ม: เพิ่มกฎเหล็ก "ห้ามใช้ลิงก์ซ้ำข้ามหัวข้อเด็ดขาด"
    prompt = f"""
...
def main():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            web_data_list = []
            seen_urls = set()  # 🎯 [เพิ่ม] ตัวช่วยจำลิงก์ที่เคยเจอแล้ว เพื่อไม่ให้เก็บข้อมูลดิบซ้ำซ้อนไปให้ AI
            ...
            for link in links:
                ...
                if t and len(t) > 12 and h and h.startswith("http") and "dmc.tv" in h:
                    ...
                    # 🎯 [เพิ่ม] กรองลิงก์ซ้ำตั้งแต่เนิ่น ๆ ลิงก์ไหนเคยบันทึกแล้ว จะไม่เก็บซ้ำอีกเด็ดขาด!
